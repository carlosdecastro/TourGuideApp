...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!City.isInitialized()) {
            ...
            Place placeToSee1 = new Place("Cidade Da Cultura", "Short Description", 1, 42.870631, -8.527591, R.drawable.ciudad_cultura, R.drawable.ciudad_cultura_full);
            Place placeToSee2 = new Place("Catedral", "Short Description", 1, 42.880637, -8.544537, R.drawable.catedral, R.drawable.catedral_full);
            Place placeToSee3 = new Place("San Martín Pinario", "Short Description", 1, 42.876896, -8.536468, R.drawable.pinario, R.drawable.pinario_full);
            Place placeToSee5 = new Place("Colegiata de Sar", "Short Description", 1, 42.871914, -8.537217, R.drawable.colegiata_sar, R.drawable.colegiata_sar_full);
            Place placeToSee4 = new Place("Facultade de Xeografía e Historia", "Short Description", 1, 42.878811, -8.542218, R.drawable.facultad_historia, R.drawable.facultad_historia_full);

            Place placeToEat1 = new Place("Casa Marcelo", "Short Description", 2, 42.881805, -8.546817, R.drawable.marcelo, R.drawable.marcelo_full);
            Place placeToEat2 = new Place("La Tafona", "Short Description", 2, 42.881022, -8.540229, R.drawable.tafona, R.drawable.tafona_full);
            Place placeToEat4 = new Place("A Maceta", "Short Description", 2, 42.882673, -8.535542, R.drawable.maceta, R.drawable.maceta_full);
